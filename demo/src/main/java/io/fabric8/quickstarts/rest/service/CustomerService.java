...
public interface CustomerService {
    ...
    /**
     * This method is mapped to an HTTP GET of '/customerservice/customers/{id}'.  The value for
     ...
     * <p/>
     * For example: surfing to '/customerservice/customers/123' will show you the information of
    ...
    /**
     * This method is mapped to an HTTP DELETE of '/customerservice/customers/{id}'.  The value for
     * {id} will be passed to this message as a parameter, using the @PathParam annotation.
     * <p/>
    ...
    public Response deleteCustomer(String type, @ApiParam(value = "ID of Customer to delete", required = true) @PathParam("id") String id);

    /**
     * This method is mapped to an HTTP GET of '/customerservice/orders/{id}'.  The value for
     * {id} will be passed to this message as a parameter, using the @PathParam annotation.
     * <p/>
